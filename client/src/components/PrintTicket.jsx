...
export default function PrintTicket({ booking }) {
  ...
  return (
    ...
    >
      ...
      {/* Date du voyage */}
      <div style={{ textAlign: "center", marginBottom: 16, fontSize: 12, color: "#555" }}>
      ...
      >
        <QRCode
          value={JSON.stringify({
            ...
            total: booking.price * booking.seats.length,
          })}
          size={100}
        />
        <div style={{ fontSize: 10, color: "#666", marginTop: 6 }}>QR Code de validation</div>
      </div>
